...
class Room():
    def __init__(self, door_num, screen, player):
        ...
        self.doors = [door.Door((1 * tile, 6 * tile), 'left'), door.Door((22 * tile, 6 * tile), 'left')]
    ...
    def generate(self, player):
        ...
        #
        self.entities.append(bat.Bat((8 * tile, 7 * tile), self.screen))
        self.entities.append(bat.Bat((16 * tile, 8 * tile), self.screen))
    ...
    def falling_walls_generate(self):
        ...
        for x in range(7):
            for y in range(1):
                falling_walls.append(wall.Wall(((x + 4) * tile, (y + 8) * tile)))
                falling_walls.append(wall.Wall(((x + 13) * tile, (y + 7) * tile)))

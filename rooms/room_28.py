...
class Room():
    ...
    def update(self):
        ...
        text_surface = my_font.render('You Escaped!', False, (250, 250, 250))

        self.screen.blit(text_surface, (54, 64))

        my_font = pygame.font.SysFont(None, 30)

        text_surface = my_font.render('Thank you for playing', False, (250, 250, 250))

        self.screen.blit(text_surface, (80, 150))

...
class Room():
    def __init__(self, door_num, screen, player):
        ...
        self.doors = [door.Door((10 * tile, 14 * tile), 'down'), door.Door((22 * tile, 6 * tile), 'left')]
    ...
    def generate(self, player):
        ...
        self.entities.append(entities.bat.Bat((10 * tile, 6 * tile), self.screen))
        self.entities.append(entities.bat.Bat((16 * tile, 9 * tile), self.screen))

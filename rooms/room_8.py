...
class Room():
    ...
    def generate(self, player):
        ...
        self.entities.append(entities.bug.Bug((8 * tile, 8 * tile), self.screen))
        self.entities.append(entities.bug.Bug((10 * tile, 6 * tile), self.screen))
        self.entities.append(entities.bug.Bug((12 * tile, 10 * tile), self.screen))
        self.entities.append(entities.bug.Bug((14 * tile, 8 * tile), self.screen))
